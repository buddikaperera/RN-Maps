///https://www.tutofox.com/react-native/tutorial-app-delivery-react-native-api-part-6-maps/

///ad manifastor sign report and goofle api key
...
export default class H2Screen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: '',
